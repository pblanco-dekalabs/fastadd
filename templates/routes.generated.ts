...
export default (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"needsAuth") : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":21,"column":4},"end":{"line":26,"column":11}}})) != null ? stack1 : "");
  ...
  return "    const "
    ...
    + "';\n    fastifyDeepInstance."
    + alias3(alias4((depth0 != null ? lookupProperty(depth0,"method") : depth0), depth0))
    + "(\"/"
    ...
    + " }, async (request, reply) =>\n      "
    + alias3(alias4((depths[1] != null ? lookupProperty(depths[1],"controllerVar") : depths[1]), depth0))
    + "."
    + alias3((lookupProperty(helpers,"camelCase")||(depth0 && lookupProperty(depth0,"camelCase"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"name") : depth0),{"name":"camelCase","hash":{},"data":data,"loc":{"start":{"line":24,"column":27},"end":{"line":24,"column":50}}}))
    + "(request, reply)\n    )\n";
  ...
  return ((stack1 = lookupProperty(helpers,"unless").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"needsAuth") : depth0),{"name":"unless","hash":{},"fn":container.program(11, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":33,"column":2},"end":{"line":37,"column":13}}})) != null ? stack1 : "");
  ...
  return "  fastify."
    ...
    + "(\"/"
    + alias2((lookupProperty(helpers,"paramCase")||(depth0 && lookupProperty(depth0,"paramCase"))||alias4).call(alias3,(depth0 != null ? lookupProperty(depth0,"name") : depth0),{"name":"paramCase","hash":{},"data":data,"loc":{"start":{"line":34,"column":28},"end":{"line":34,"column":51}}}))
    + "\", { schema: "
    + alias2((lookupProperty(helpers,"camelCase")||(depth0 && lookupProperty(depth0,"camelCase"))||alias4).call(alias3,(depth0 != null ? lookupProperty(depth0,"name") : depth0),{"name":"camelCase","hash":{},"data":data,"loc":{"start":{"line":34,"column":64},"end":{"line":34,"column":87}}}))
    + " }, async (request, reply) =>\n    "
    + alias2(alias1((depths[1] != null ? lookupProperty(depths[1],"controllerVar") : depths[1]), depth0))
    + "."
    + alias2((lookupProperty(helpers,"camelCase")||(depth0 && lookupProperty(depth0,"camelCase"))||alias4).call(alias3,(depth0 != null ? lookupProperty(depth0,"name") : depth0),{"name":"camelCase","hash":{},"data":data,"loc":{"start":{"line":35,"column":25},"end":{"line":35,"column":48}}}))
    + "(request, reply)\n  )\n";
  ...
  return "import { FastifyInstance } from \"fastify\"\n\nimport { "
    ...
    + "\"\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,((stack1 = (depth0 != null ? lookupProperty(depth0,"info") : depth0)) != null ? lookupProperty(stack1,"crud") : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":4,"column":0},"end":{"line":6,"column":7}}})) != null ? stack1 : "")
    + "import { server } from \"@/server/config/fastify\"\n\nimport {\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,((stack1 = (depth0 != null ? lookupProperty(depth0,"info") : depth0)) != null ? lookupProperty(stack1,"children") : stack1),{"name":"each","hash":{},"fn":container.program(3, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":10,"column":2},"end":{"line":12,"column":11}}})) != null ? stack1 : "")
    + "  "
    ...
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,((stack1 = (depth0 != null ? lookupProperty(depth0,"info") : depth0)) != null ? lookupProperty(stack1,"children") : stack1),{"name":"each","hash":{},"fn":container.program(5, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":20,"column":4},"end":{"line":27,"column":13}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,((stack1 = (depth0 != null ? lookupProperty(depth0,"info") : depth0)) != null ? lookupProperty(stack1,"crud") : stack1),{"name":"if","hash":{},"fn":container.program(8, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":28,"column":4},"end":{"line":30,"column":11}}})) != null ? stack1 : "")
    + "  })\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,((stack1 = (depth0 != null ? lookupProperty(depth0,"info") : depth0)) != null ? lookupProperty(stack1,"children") : stack1),{"name":"each","hash":{},"fn":container.program(10, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":32,"column":2},"end":{"line":38,"column":11}}})) != null ? stack1 : "")
    + "\n  next()\n}\n\nexport default "
